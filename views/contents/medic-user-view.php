<main class="full-box main-container">
    ...
    <section class="full-box page-content">
        ...
        <div class="full-box page-header">
            <h3 class="text-left">
                <i class="fas fa-plus fa-fw"></i> &nbsp; CITA MÉDICA
            </h3>
        </div>
        ...
        <div class="container-fluid">
            <ul class="full-box list-unstyled page-nav-tabs">
                <li>
                    <a class="active" href="../../index.php"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO PRÉSTAMO</a>
                </li>
                <li>
                    <a href="../../index.php"><i class="far fa-calendar-alt"></i> &nbsp; PROXIMA CITA</a>
                </li>
                <li>
                    <a href="../../index.php"><i class="fas fa-hand-holding-usd fa-fw"></i> &nbsp; ESTUDIOS</a>
                </li>
                <li>
                    <a href="../../index.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; REFERENCIA MÉDICAS</a>
                </li>
                <li>
                    <a href="../../index.php"><i class="fas fa-search-dollar fa-fw"></i> &nbsp; BUSCAR PACIENTE </a>
                </li>
            </ul>
        </div>
