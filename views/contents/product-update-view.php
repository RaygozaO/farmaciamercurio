    ...
    <section class="full-box page-content">
        ...
        <div class="container-fluid">
            <ul class="full-box list-unstyled page-nav-tabs">
                <li>
                    <a href="../../index.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR ITEM</a>
                </li>
                <li>
                    <a href="../../index.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE ITEMS</a>
                </li>
                <li>
                    <a href="../../index.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ITEM</a>
                </li>
            </ul>
        </div>
