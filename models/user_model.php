...
class user_model extends main_model {
    ...
    protected static function add_user_model($datos) {
        ...
        try {
            ...
            $query_municipio->bindParam(":nombremunicipio", $datos['nombre_municipio']);
            ...
            $query_colonia->bindParam(":nombrecolonia", $datos['nombre_colonia']);
            ...
            $query_cp->bindParam(":codigopostal", $datos['codigo_postal']);
            $query_cp->execute();
